...
const eras = [
  ...
  },
  {
    ...
    label: "2023\u201325",
    era: "Expansion",
    body: "The competition expanded. Health systems aren't just competing with each other for talent anymore. Managed service providers, consulting firms, and startups with venture runway are all hiring from the same pool.",
    accent: "var(--teal)",
  },
  {
    num: "04",
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 md:px-10">
          ...
          >
            ...
            <h2 className="font-display text-3xl leading-tight text-foreground md:text-6xl lg:text-7xl">
              The job got harder.
              <br />
              <em className="text-teal">Most firms didn't keep up.</em>
            </h2>
          </div>
          ...
          >
            <p className="font-display text-2xl leading-snug text-foreground md:text-4xl lg:text-5xl">
              ...
              <span className="text-teal">We're in your corner.</span>
            </p>
          </div>
        </div>
      </div>
