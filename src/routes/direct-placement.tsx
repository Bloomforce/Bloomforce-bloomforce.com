  ...
  return (
    <section ref={ref} className="bg-cream py-24 md:py-36">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div
          className={`hidden overflow-hidden rounded-2xl border border-ink/10 bg-white shadow-lg shadow-ink/[0.06] md:block transition-all duration-1000 delay-200 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          {/* Navy header row */}
          <div className="grid grid-cols-[1.2fr_2fr_2fr] bg-navy-dark">
            ...
            <div className="border-l border-white/10 bg-teal/[0.18] px-6 py-5">
              <div className="flex items-center gap-2.5">
                <span className="h-2 w-2 rounded-sm bg-teal-light" />
                <span className="font-mono text-[11px] font-semibold uppercase tracking-[0.2em] text-teal-light">
                  Bloomforce
                </span>
              </div>
            </div>
          ...
          {comparisonRows.map((row, i) => (
            <div
              ...
              className={`grid grid-cols-[1.2fr_2fr_2fr] ${
                i !== comparisonRows.length - 1 ? "border-b border-ink/[0.06]" : ""
              }`}
            >
              ...
              <div className="border-l border-ink/[0.06] px-6 py-6">
                <p className="text-sm font-medium leading-relaxed text-ink-muted">{row.bigFirm}</p>
              </div>
              <div className="border-l border-ink/[0.06] bg-teal/[0.045] px-6 py-6">
                <p className="text-sm font-medium leading-relaxed text-[#0d4a50]">{row.bloomforce}</p>
              </div>
            </div>
          ))}

          {/* Closing statement — navy banner with gradient top accent */}
          <div className="relative overflow-hidden bg-navy-dark px-8 py-7">
            <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-teal to-teal-light" />
            <p className="text-center text-lg font-medium leading-snug text-white md:text-xl">
        ...
        <div className="space-y-6 md:hidden">
          {comparisonRows.map((row) => (
            ...
            >
              <div className="bg-navy-dark px-5 py-3">
                <h3 className="text-sm font-bold text-white">{row.dimension}</h3>
              </div>
              <div className="p-5">
              ...
              <div className="border-t border-ink/[0.06] bg-teal/[0.045] p-5">
                <div className="mb-1.5 flex items-center gap-2">
                  <span className="h-2 w-2 rounded-sm bg-teal-light" />
                  <span className="font-mono text-[10px] font-semibold uppercase tracking-wider text-teal">
                    Bloomforce
                  </span>
                </div>
                <p className="text-sm font-medium leading-relaxed text-[#0d4a50]">{row.bloomforce}</p>
          ...
          <div className="relative overflow-hidden rounded-xl bg-navy-dark px-6 py-5">
            <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-teal to-teal-light" />
